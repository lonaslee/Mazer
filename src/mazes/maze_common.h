...
/**
 * @brief Maze generation functions call this function on every "step" of the
 *        algorithm to display the step. This uses the ScreenLock object from
 *        get_screen_lock(void) to synchronize with the main thread.
 */
